...
const Sponsors = () => {
    return (
        <div className='flex flex-col items-center'>
            ...
            <div className='flex space-x-10 justify-center items-center mt-4'>
                <a className='max-w-[33%]' href=""><img src="https://1000logos.net/wp-content/uploads/2021/05/LetyShops-logo.png" alt="Letyshops"/></a>
                <a className='max-w-[33%]' href=""><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/Logo_g2a_white.svg/1200px-Logo_g2a_white.svg.png" alt="G2A"/></a>
                <a className='max-w-[33%]' href=""><img src="https://racetracks.pl/wp-content/uploads/2022/08/cropped-logo-new-bez-tla.png" alt="Racetracks.pl"/></a>
            </div>
        </div>
    )
}
