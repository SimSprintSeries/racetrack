...
const Nav = () => {
    ...
    return (
        <header id='section0' className="flex p-4 place-items-center gap-4">
            ...
            <nav className={'flex flex-col flex-grow-1 lg:flex-row fixed right-0 top-0 bg-nav/95 box-content h-full z-40 ease-linear duration-100 overflow-hidden ' + `${navVisibility ? 'pl-4 pr-16' : 'w-0'}`}>
